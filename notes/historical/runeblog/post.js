...
CloudflareApps.siteId = "cd79c64d6d1fd5d21b93ef34a03d3e93";
...
CloudflareApps.installs["pb7j-inMIDdy"] = {
  appId: "lMxPPXVOqmoE",
  scope: {}
};;

CloudflareApps.installs["pb7j-inMIDdy"].options = {
  "id": "UA-4769553-53",
  "social": true
};;

if (CloudflareApps.matchPage(CloudflareApps.installs['pb7j-inMIDdy'].URLPatterns)) {
...
if (CloudflareApps.matchPage(CloudflareApps.installs['pb7j-inMIDdy'].URLPatterns)) {
  (function() {
    var options = CloudflareApps.installs['pb7j-inMIDdy'].options
