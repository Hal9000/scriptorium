...
def id
  setvar("this.id", api.args.first)
end

def title
  setvar("this.title", api.data)
end

def created
  setvar("this.created", Time.now.strftime("%Y-%m-%d-%H-%M-%S"))
end

def views
  setvar("this.views", api.data.strip.split)
end
